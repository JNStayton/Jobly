...
describe('POST /companies', function() {
	...
	test('not ok for not admin', async () => {
...
describe('GET /companies', function() {
	...
	test('accepts single query parameter', async () => {
	...
	test('accepts multiple query parameters', async () => {
	...
	test('throws error with incorrect query', async () => {
		const resp = await request(app).get('/companies').query({ buttcheeks: 3 });
		expect(resp.statusCode).toEqual(400);
	});
	...
	test('works for anon', async function() {
		...
		expect(resp.body).toEqual({
			company: {
				...
				logoUrl: 'http://c1.img',
				jobs: [
					{ id: testJobIds[0], companyHandle: 'c1', title: 'J1', equity: 0.1, salary: 1 },
					{ id: testJobIds[1], companyHandle: 'c1', title: 'J2', equity: 0.2, salary: 2 },
					{ id: testJobIds[2], companyHandle: 'c1', title: 'J3', equity: null, salary: 3 }
				]
			}
		});
	});
